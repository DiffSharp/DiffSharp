...
and D(x:ADD) =
    ...
    override d.ToString() =
        ...
        s (d.toADD())
    static member op_Implicit(d:D):float32 = float32 (d.toADD())
    static member op_Implicit(a:float32):D = D(a)
    ...
    static member (*) (a:D, b:int) = a * (D (float32 b))
    static member (/) (a:D, b:int) = a / (D (float32 b))
    static member Pow (a:D, b:int) = D.Pow(a, (D (float32 b)))
    static member Atan2 (a:D, b:int) = D.Atan2(a, (D (float32 b)))
    // int - D binary operations
    static member (+) (a:int, b:D) = (D (float32 a)) + b
    static member (-) (a:int, b:D) = (D (float32 a)) - b
    static member (*) (a:int, b:D) = (D (float32 a)) * b
    static member (/) (a:int, b:D) = (D (float32 a)) / b
    static member Pow (a:int, b:D) = D.Pow((D (float32 a)), b)
    static member Atan2 (a:int, b:D) = D.Atan2((D (float32 a)), b)
    // D unary operations
...
and internal ADDV = DiffSharp.AD.Float32.DV

and DV(v:ADDV) =
    new(v:float32[]) = DV(ADDV.DV(v))
    new(v:D[]) = DV(DiffSharp.AD.Float32.DOps.toDV(v |> Array.map D.DtoADD))
    ...
    static member (*) (a:DV, b:int) = a * (D (float32 b))
    static member (/) (a:DV, b:int) = a / (D (float32 b))
    static member Pow (a:DV, b:int) = DV.Pow(a, (D (float32 b)))
...
and DM(m:ADDM) =
    ...
    static member (*) (a:DM, b:int) = a * (D (float32 b))
    static member (/) (a:DM, b:int) = a / (D (float32 b))
    static member Pow (a:DM, b:int) = DM.Pow(a, (D (float32 b)))
...
type AD =
    ...
    static member Diff(f:System.Func<D,D>) = System.Func<D,D>(D.DtoADD >> (DiffSharp.AD.Float32.DiffOps.diff (D.ADDtoD >> f.Invoke >> D.DtoADD)) >> D.ADDtoD)
    /// First derivative of a scalar-to-scalar function `f`, at point `x`
    static member Diff(f:System.Func<D,D>, x:D) = D.ADDtoD <| DiffSharp.AD.Float32.DiffOps.diff (D.ADDtoD >> f.Invoke >> D.DtoADD) (x |> D.DtoADD)
    /// Second derivative of a scalar-to-scalar function `f`
    static member Diff2(f:System.Func<D,D>) = System.Func<D,D>(D.DtoADD >> (DiffSharp.AD.Float32.DiffOps.diff2 (D.ADDtoD >> f.Invoke >> D.DtoADD)) >> D.ADDtoD)
    /// Second derivative of a scalar-to-scalar function `f`, at point `x`
    static member Diff2(f:System.Func<D,D>, x:D) = D.ADDtoD <| DiffSharp.AD.Float32.DiffOps.diff2 (D.ADDtoD >> f.Invoke >> D.DtoADD) (x |> D.DtoADD)
    /// `n`-th derivative of a scalar-to-scalar function `f`
    static member Diffn(n:int, f:System.Func<D,D>) = System.Func<D,D>(D.DtoADD >> (DiffSharp.AD.Float32.DiffOps.diffn n (D.ADDtoD >> f.Invoke >> D.DtoADD)) >> D.ADDtoD)
    /// `n`-th derivative of a scalar-to-scalar function `f`, at point `x`
    static member Diffn(n:int, f:System.Func<D,D>, x:D) = D.ADDtoD <| DiffSharp.AD.Float32.DiffOps.diffn n (D.ADDtoD >> f.Invoke >> D.DtoADD) (x |> D.DtoADD)
    /// Gradient-vector product (directional derivative) of a vector-to-scalar function `f`, at point `x`, along vector `v`
    static member Gradv(f:System.Func<DV,D>, x:DV, v:DV) = D.ADDtoD <| DiffSharp.AD.Float32.DiffOps.gradv (DV.ADDVtoDV >> f.Invoke >> D.DtoADD) (x |> DV.DVtoADDV) (v |> DV.DVtoADDV)
    /// Gradient of a vector-to-scalar function `f`
    static member Grad(f:System.Func<DV,D>) = System.Func<DV,DV>(DV.DVtoADDV >> (DiffSharp.AD.Float32.DiffOps.grad (DV.ADDVtoDV >> f.Invoke >> D.DtoADD)) >> DV.ADDVtoDV)
    /// Gradient of a vector-to-scalar function `f`, at point `x`
    static member Grad(f:System.Func<DV,D>, x:DV) = DV.ADDVtoDV <| DiffSharp.AD.Float32.DiffOps.grad ((DV.ADDVtoDV) >> f.Invoke >> D.DtoADD) (x |> DV.DVtoADDV)
    /// Laplacian of a vector-to-scalar function `f`
    static member Laplacian(f:System.Func<DV,D>) = System.Func<DV,D>(DV.DVtoADDV >> (DiffSharp.AD.Float32.DiffOps.laplacian (DV.ADDVtoDV >> f.Invoke >> D.DtoADD)) >> D.ADDtoD)
    /// Laplacian of a vector-to-scalar function `f`, at point `x`
    static member Laplacian(f:System.Func<DV,D>, x:DV) = D.ADDtoD <| DiffSharp.AD.Float32.DiffOps.laplacian (DV.ADDVtoDV >> f.Invoke >> D.DtoADD) (x |> DV.DVtoADDV)
    /// Jacobian-vector product of a vector-to-vector function `f`, at point `x`, along vector `v`
    static member Jacobianv(f:System.Func<DV,DV>, x:DV, v:DV) = DV.ADDVtoDV <| DiffSharp.AD.Float32.DiffOps.jacobianv (DV.ADDVtoDV >> f.Invoke >> DV.DVtoADDV) (x |> DV.DVtoADDV) (v |> DV.DVtoADDV)
    /// Transposed Jacobian-vector product of a vector-to-vector function `f`, at point `x`, along vector `v`
    static member JacobianTv(f:System.Func<DV,DV>, x:DV, v:DV) = DV.ADDVtoDV <| DiffSharp.AD.Float32.DiffOps.jacobianTv (DV.ADDVtoDV >> f.Invoke >> DV.DVtoADDV) (x |> DV.DVtoADDV) (v |> DV.DVtoADDV)
    /// Jacobian of a vector-to-vector function `f`
    static member Jacobian(f:System.Func<DV,DV>) = System.Func<DV,DM>(DV.DVtoADDV >> (DiffSharp.AD.Float32.DiffOps.jacobian (DV.ADDVtoDV >> f.Invoke >> DV.DVtoADDV)) >> DM.ADDMtoDM)
    /// Jacobian of a vector-to-vector function `f`, at point `x`
    static member Jacobian(f:System.Func<DV,DV>, x:DV) = DM.ADDMtoDM <| DiffSharp.AD.Float32.DiffOps.jacobian (DV.ADDVtoDV >> f.Invoke >> DV.DVtoADDV) (x |> DV.DVtoADDV)
    /// Transposed Jacobian of a vector-to-vector function `f`
    static member JacobianT(f:System.Func<DV,DV>) = System.Func<DV,DM>(DV.DVtoADDV >> (DiffSharp.AD.Float32.DiffOps.jacobianT (DV.ADDVtoDV >> f.Invoke >> DV.DVtoADDV)) >> DM.ADDMtoDM)
    /// Transposed Jacobian of a vector-to-vector function `f`, at point `x`
    static member JacobianT(f:System.Func<DV,DV>, x:DV) = DM.ADDMtoDM <| DiffSharp.AD.Float32.DiffOps.jacobianT (DV.ADDVtoDV >> f.Invoke >> DV.DVtoADDV) (x |> DV.DVtoADDV)
    /// Hessian of a vector-to-scalar function `f`
    static member Hessian(f:System.Func<DV,D>) = System.Func<DV,DM>(DV.DVtoADDV >> (DiffSharp.AD.Float32.DiffOps.hessian (DV.ADDVtoDV >> f.Invoke >> D.DtoADD)) >> DM.ADDMtoDM)
    /// Hessian of a vector-to-scalar function `f`, at point `x`
    static member Hessian(f:System.Func<DV,D>, x:DV) = DM.ADDMtoDM <| DiffSharp.AD.Float32.DiffOps.hessian (DV.ADDVtoDV >> f.Invoke >> D.DtoADD) (x |> DV.DVtoADDV)
    /// Hessian-vector product of a vector-to-scalar function `f`, at point `x`
    static member Hessianv(f:System.Func<DV,D>, x:DV, v:DV) = DV.ADDVtoDV <| DiffSharp.AD.Float32.DiffOps.hessianv (DV.ADDVtoDV >> f.Invoke >> D.DtoADD) (x |> DV.DVtoADDV) (v |> DV.DVtoADDV)
    /// Curl of a vector-to-vector function `f`. Supported only for functions with a three-by-three Jacobian matrix.
    static member Curl(f:System.Func<DV,DV>) = System.Func<DV,DV>(DV.DVtoADDV >> (DiffSharp.AD.Float32.DiffOps.curl (DV.ADDVtoDV >> f.Invoke >> DV.DVtoADDV)) >> DV.ADDVtoDV)
    /// Curl of a vector-to-vector function `f`, at point `x`. Supported only for functions with a three-by-three Jacobian matrix.
    static member Curl(f:System.Func<DV,DV>, x:DV) = DV.ADDVtoDV <| DiffSharp.AD.Float32.DiffOps.curl (DV.ADDVtoDV >> f.Invoke >> DV.DVtoADDV) (x |> DV.DVtoADDV)
    /// Divergence of a vector-to-vector function `f`. Defined only for functions with a square Jacobian matrix.
    static member Div(f:System.Func<DV,DV>) = System.Func<DV,D>(DV.DVtoADDV >> (DiffSharp.AD.Float32.DiffOps.div (DV.ADDVtoDV >> f.Invoke >> DV.DVtoADDV)) >> D.ADDtoD)
    /// Divergence of a vector-to-vector function `f`, at point `x`. Defined only for functions with a square Jacobian matrix.
    static member Div(f:System.Func<DV,DV>, x:DV) = D.ADDtoD <| DiffSharp.AD.Float32.DiffOps.div (DV.ADDVtoDV >> f.Invoke >> DV.DVtoADDV) (x |> DV.DVtoADDV)
...
type Numerical =
    /// First derivative of a scalar-to-scalar function `f`
    static member Diff(f:System.Func<float32,float32>) = System.Func<float32, float32>(DiffSharp.Numerical.Float32.DiffOps.diff f.Invoke)
    /// First derivative of a scalar-to-scalar function `f`, at point `x`
    static member Diff(f:System.Func<float32,float32>, x:float32) = DiffSharp.Numerical.Float32.DiffOps.diff f.Invoke x
    /// Second derivative of a scalar-to-scalar function `f`
    static member Diff2(f:System.Func<float32,float32>) = System.Func<float32, float32>(DiffSharp.Numerical.Float32.DiffOps.diff2 f.Invoke)
    /// Second derivative of a scalar-to-scalar function `f`, at point `x`
    static member Diff2(f:System.Func<float32,float32>, x:float32) = DiffSharp.Numerical.Float32.DiffOps.diff2 f.Invoke x
    /// Gradient-vector product (directional derivative) of a vector-to-scalar function `f`, at point `x`, along vector `v`
    static member Gradv(f:System.Func<float32[],float32>, x:float32[], v:float32[]) = DiffSharp.Numerical.Float32.DiffOps.gradv f.Invoke x v
    /// Gradient of a vector-to-scalar function `f`
    static member Grad(f:System.Func<float32[],float32>) = System.Func<float32[],float32[]>(DiffSharp.Numerical.Float32.DiffOps.grad f.Invoke)
    /// Gradient of a vector-to-scalar function `f`, at point `x`
    static member Grad(f:System.Func<float32[],float32>, x:float32[]) = DiffSharp.Numerical.Float32.DiffOps.grad f.Invoke x
    /// Hessian-vector product of a vector-to-scalar function `f`, at point `x`, along vector `v`
    static member Hessianv(f:System.Func<float32[],float32>, x:float32[], v:float32[]) = DiffSharp.Numerical.Float32.DiffOps.hessianv f.Invoke x v
    /// Hessian of a vector-to-scalar function `f`
    static member Hessian(f:System.Func<float32[],float32>) = System.Func<float32[],float32[,]>(DiffSharp.Numerical.Float32.DiffOps.hessian f.Invoke)
    /// Hessian of a vector-to-scalar function `f`, at point `x`
    static member Hessian(f:System.Func<float32[],float32>, x:float32[]) = DiffSharp.Numerical.Float32.DiffOps.hessian f.Invoke x
    /// Laplacian of a vector-to-scalar function `f`
    static member Laplacian(f:System.Func<float32[],float32>) = System.Func<float32[],float32>(DiffSharp.Numerical.Float32.DiffOps.laplacian f.Invoke)
    /// Laplacian of a vector-to-scalar function `f`, at point `x`
    static member Laplacian(f:System.Func<float32[],float32>, x:float32[]) = DiffSharp.Numerical.Float32.DiffOps.laplacian f.Invoke x
    /// Jacobian-vector product of a vector-to-vector function `f`, at point `x`, along vector `v`
    static member Jacobianv(f:System.Func<float32[],float32[]>, x:float32[], v:float32[]) = DiffSharp.Numerical.Float32.DiffOps.jacobianv f.Invoke x v
    /// Jacobian of a vector-to-vector function `f`
    static member Jacobian(f:System.Func<float32[],float32[]>) = System.Func<float32[],float32[,]>(DiffSharp.Numerical.Float32.DiffOps.jacobian f.Invoke)
    /// Jacobian of a vector-to-vector function `f`, at point `x`
    static member Jacobian(f:System.Func<float32[],float32[]>, x:float32[]) = DiffSharp.Numerical.Float32.DiffOps.jacobian f.Invoke x
    /// Transposed Jacobian of a vector-to-vector function `f`
    static member JacobianT(f:System.Func<float32[],float32[]>) = System.Func<float32[],float32[,]>(DiffSharp.Numerical.Float32.DiffOps.jacobianT f.Invoke)
    /// Transposed Jacobian of a vector-to-vector function `f`, at point `x`
    static member JacobianT(f:System.Func<float32[],float32[]>, x:float32[]) = DiffSharp.Numerical.Float32.DiffOps.jacobianT f.Invoke x
    /// Curl of a vector-to-vector function `f`. Supported only for functions with a three-by-three Jacobian matrix.
    static member Curl(f:System.Func<float32[],float32[]>) = System.Func<float32[],float32[]>(DiffSharp.Numerical.Float32.DiffOps.curl f.Invoke)
    /// Curl of a vector-to-vector function `f`, at point `x`. Supported only for functions with a three-by-three Jacobian matrix.
    static member Curl(f:System.Func<float32[],float32[]>, x:float32[]) = DiffSharp.Numerical.Float32.DiffOps.curl f.Invoke x
    /// Divergence of a vector-to-vector function `f`. Defined only for functions with a square Jacobian matrix.
    static member Div(f:System.Func<float32[],float32[]>) = System.Func<float32[],float32>(DiffSharp.Numerical.Float32.DiffOps.div f.Invoke)
    /// Divergence of a vector-to-vector function `f`, at point `x`. Defined only for functions with a square Jacobian matrix.
    static member Div(f:System.Func<float32[],float32[]>, x:float32[]) = DiffSharp.Numerical.Float32.DiffOps.div f.Invoke x
