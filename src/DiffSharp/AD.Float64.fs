...
let inline fail_with_invalid_type_message () = failwith "Unsupported type. Expecting D, float, or int."

let [<Literal>] internal numberMinus1 = -1.
let [<Literal>] internal number0_5    = 0.5
let [<Literal>] internal number0      = 0.
