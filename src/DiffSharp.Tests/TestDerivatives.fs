    ...
    member this.TestDerivativeConv2Ds2p2 () =
        ...
        [[[  0.0000,   0.0000,   0.0000,   0.0000],
         ...
         [[  0.0000,   0.0000,   0.0000,   0.0000],
          ...
          [  0.0000,  17.8893, -28.4861,   0.0000],
          [  0.0000,   0.0000,   0.0000,   0.0000]]]])
        revz.reverse(dsharp.tensor([[[[ 6.7571e+00,  9.0846e+00, -2.3487e+00,  4.3374e+00],
        ...
        let revxd = revx.derivative
        let revxdCorrect = dsharp.tensor([[[[-9.0342e+00,  7.9611e+01, -1.3431e+00,  9.6403e+00],
        ...
        let revyd = revy.derivative
        let revydCorrect = dsharp.tensor([[[[ -92.7970,  -19.9241],
          [-103.8568,   27.1854]],
...
/// 
    ...
    member this.TestDerivativeConv3Ds2p2 () =
        ...
        let fwdzCorrect = dsharp.tensor([[[[-1.2082,  0.4474,  0.7099],
                                              [ 5.4662,  2.3415,  0.2347],
                                              [ 2.4068, -1.2033, -0.6632]],
                                   
                                             [[ 7.1204, -6.9272, -0.0190],
                                              [ 0.0715,  3.1109, -6.1003],
                                              [-0.5796, -4.5237,  0.6796]],
                                   
                                             [[-1.6718,  0.5233, -2.0133],
                                              [ 2.3582,  2.0787, -2.4861],
                                              [-1.1513, -1.9845,  2.3267]]]]).unsqueeze(0)
        let fwdzd = fwdz.derivative
        let fwdzdCorrect = dsharp.tensor([[[[ -3.5440,  -2.5150,   1.1529],
                                                [ -0.5226,  -2.3338,   5.6010],
                                                [  2.1810,   0.4096,  -2.4931]],
                                     
                                               [[  1.6143, -13.1822,   3.6669],
                                                [  2.5171,  11.2710,  -8.6581],
                                                [  1.6695,  -1.0182,  -3.2682]],
                                     
                                               [[ -0.5828,  -4.4725,   3.4342],
                                                [  2.7831,  -0.9133,   9.4461],
                                                [  4.5680,   3.2443,   7.3158]]]]).unsqueeze(0)
        ...
        let revzCorrect = dsharp.tensor([[[[-1.2082,  0.4474,  0.7099],
                                            [ 5.4662,  2.3415,  0.2347],
                                            [ 2.4068, -1.2033, -0.6632]],
                                           ...
                                           [[-1.6718,  0.5233, -2.0133],
                                            [ 2.3582,  2.0787, -2.4861],
                                            [-1.1513, -1.9845,  2.3267]]]]).unsqueeze(0)
        revz.reverse(dsharp.tensor([[[[ 1.0795,  1.0202,  0.7958],
                                        [ 0.6235, -0.4311, -0.9402],
                                        [ 1.9344, -0.2129,  0.1964]],
                             
                                       [[-0.4597, -0.4112, -1.5955],
                                        [-0.2240,  1.1750,  0.7400],
                                        [ 1.4712,  0.4727,  0.4647]],
                             
                                       [[ 0.0122, -0.7695, -0.8825],
                                        [ 1.1399,  0.7910, -0.3428],
                                        [ 0.4024,  0.4828,  1.8467]]]]).unsqueeze(0))         
        let revxd = revx.derivative
        let revxdCorrect = dsharp.tensor([[[[-2.2351e+00,  4.5736e-01,  1.9992e-01, -3.0748e-01],
                                              [-1.4548e+00, -2.1897e-01,  2.7145e-01,  8.9256e-04],
                                              [-2.1170e+00, -4.6750e-01,  5.5184e-01, -1.2898e+00],
                                              [-2.6659e+00, -7.9902e-02,  7.9888e-01, -1.6277e-01]],
                                   
                                             [[-4.9402e-01, -5.8587e-01,  2.0912e+00, -4.5123e-01],
                                              [-6.1256e-01,  4.3116e-02, -2.7438e+00,  2.7154e-02],
                                              [ 2.2122e+00, -1.5322e-01, -1.1893e+00, -1.7616e-01],
                                              [-3.0439e+00,  1.7347e-02, -1.2480e+00,  1.7052e-02]],
                                   
                                             [[ 3.0599e+00, -1.0882e+00,  4.6827e+00, -2.3300e+00],
                                              [ 2.1754e+00, -4.5157e-01, -7.9639e-01, -6.3617e-02],
                                              [ 3.0454e-01,  1.9585e+00, -8.0460e-01, -6.5778e-02],
                                              [-1.6521e+00, -2.2486e-01,  1.0725e-01, -5.8128e-01]],
                                   
                                             [[ 1.3550e+00, -4.2476e-01,  2.6052e+00,  1.0922e-01],
                                              [-2.7252e+00,  2.9028e-02, -1.1216e+00, -1.2578e-02],
                                              [-1.2727e+00, -1.8164e-01, -1.4797e+00, -9.0215e-01],
                                              [-1.1376e+00,  1.7715e-02, -2.4586e+00,  6.7767e-02]]],
                                   
                                   
                                            [[[ 1.2127e+00,  4.0796e-01,  5.7156e+00,  1.5053e-01],
                                              [ 3.4565e-01, -6.8422e-01, -2.0617e-02, -9.6428e-01],
                                              [-5.9139e-01,  1.4349e-01, -1.5555e+00,  6.9472e-01],
                                              [ 4.1555e+00, -3.0678e-01,  1.3166e-02,  2.2082e-02]],
                                   
                                             [[ 1.3372e+00, -1.1092e+00, -1.7150e-01, -2.3281e+00],
                                              [-3.9238e-01,  9.0387e-01, -1.2225e-01,  5.6925e-01],
                                              [-2.2926e-01,  1.1880e+00, -1.8074e+00,  6.6184e-01],
                                              [-9.7215e-03,  3.6366e-01, -1.0192e-01,  3.5747e-01]],
                                   
                                             [[ 1.7173e+00,  1.7001e+00,  8.0385e-01,  1.0277e+00],
                                              [ 7.2877e-01,  7.0805e-01,  2.7992e+00,  6.8952e-01],
                                              [-7.3139e-01, -1.4379e-02,  1.9938e+00,  1.5789e+00],
                                              [ 2.6207e+00,  2.3722e-01,  7.6667e-01, -1.6429e-01]],
                                   
                                             [[-6.1678e-01, -1.3475e+00,  3.0652e-01, -8.9869e-01],
                                              [-1.4170e-01,  6.0854e-01,  1.8333e-01, -2.6368e-01],
                                              [-1.6841e+00,  7.1475e-01, -7.9636e-01, -1.3733e+00],
                                              [-1.1431e-01,  3.7138e-01, -5.3751e-01,  1.4206e+00]]]]).unsqueeze(0)
        let revyd = revy.derivative
        let revydCorrect = dsharp.tensor([[[[ 0.4080, -1.1312, -1.5085],
                                              [-1.2575,  0.4419, -0.8024],
                                              [-2.6790, -0.9950, -2.7376]],
                                   
                                             [[-1.0251, -0.5126, -2.2459],
                                              [ 0.2027, -0.5834, -1.5784],
                                              [-0.0378,  0.3806,  1.9886]],
                                   
                                             [[-2.0395, -2.8823, -0.5225],
                                              [ 2.5419, -0.6380, -0.1757],
                                              [ 0.8968,  2.8395,  1.8252]]],
                                   
                                   
                                            [[[ 2.1789, -0.5744,  2.5388],
                                              [ 0.5409,  2.4749,  2.7282],
                                              [ 0.7264,  4.0628, -2.6724]],
                                   
                                             [[ 0.2921, -0.6201, -0.0427],
                                              [-0.0257,  0.1447,  4.1496],
                                              [-3.9109,  3.9357, -2.1008]],
                                   
                                             [[-0.7808, -0.5291,  2.6022],
                                              [ 0.6878, -0.2306,  1.3279],
                                              [-1.7699, -0.3086,  2.2887]]]]).unsqueeze(0)
    ...
    member this.TestDerivativeConv2Ds23p32d23 () =
        ...
        [[[   0.0000,    0.0000],
         ...
         [[   0.0000,    0.0000],
          ...
          [  51.1217,   28.2248],
          [  14.2171,  -23.6501]]]])
        revz.reverse(dsharp.tensor([[[[ 9.3434,  2.6928],
          [ 1.0891, -3.7427],
          [-1.4629,  2.3710],
          [-6.0087,  0.0640]],
        ...
        let revyd = revy.derivative
        let revydCorrect = dsharp.tensor([[[[-7.9097e+00, -1.0028e+01],
