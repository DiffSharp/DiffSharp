...
# Build libTorchSharp
RUN cd /code && git clone https://github.com/DiffSharp/LibTorchSharp.git && cd LibTorchSharp && git checkout b870e00 && cmake -DTorch_DIR=/code/libtorch/share/cmake/Torch -DCMAKE_BUILD_TYPE="Release" . && make
