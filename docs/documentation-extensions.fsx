...
You would then use the [`Tensor.UnaryOp`](reference/diffsharp-tensor.html#UnaryOp) method to create the `Tensor->Tensor` or [`Tensor.BinaryOp`](reference/diffsharp-tensor.html#BinaryOp) to create the `Tensor*Tensor->Tensor` function. You would typically also extend the [`Tensor`](reference/diffsharp-tensor.html) type with your newly defined function.
