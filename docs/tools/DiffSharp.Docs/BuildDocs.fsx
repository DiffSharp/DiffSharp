...
Literate.ProcessScriptFile(relative "input/examples-stabilityanalysis.fsx", relative "input/templates/template.html", relative "output/examples-stabilityanalysis.html", replacements = tags, fsiEvaluator = FsiEvaluator())
