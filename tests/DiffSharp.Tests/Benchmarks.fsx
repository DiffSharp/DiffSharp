...
let res_jacobianT_AD_Forward, dur_jacobianT_AD_Forward = duration (fun () -> DiffSharp.AD.Forward.ForwardOps.jacobianT (fun x -> [|(sin x.[0]) ** x.[1]; sqrt (x.[1] + x.[2]); log (x.[0] * x.[2])|]) xv)
let res_jacobianT_AD_Forward2, dur_jacobianT_AD_Forward2 = duration (fun () -> DiffSharp.AD.Forward2.Forward2Ops.jacobianT (fun x -> [|(sin x.[0]) ** x.[1]; sqrt (x.[1] + x.[2]); log (x.[0] * x.[2])|]) xv)
let res_jacobianT_AD_ForwardG, dur_jacobianT_AD_ForwardG = duration (fun () -> DiffSharp.AD.ForwardG.ForwardGOps.jacobianT (fun x -> [|(sin x.[0]) ** x.[1]; sqrt (x.[1] + x.[2]); log (x.[0] * x.[2])|]) xv)
let res_jacobianT_AD_ForwardGH, dur_jacobianT_AD_ForwardGH = duration (fun () -> DiffSharp.AD.ForwardGH.ForwardGHOps.jacobianT (fun x -> [|(sin x.[0]) ** x.[1]; sqrt (x.[1] + x.[2]); log (x.[0] * x.[2])|]) xv)
let res_jacobianT_AD_ForwardN, dur_jacobianT_AD_ForwardN = duration (fun () -> DiffSharp.AD.ForwardN.ForwardNOps.jacobianT (fun x -> [|(sin x.[0]) ** x.[1]; sqrt (x.[1] + x.[2]); log (x.[0] * x.[2])|]) xv)
let res_jacobianT_AD_Reverse, dur_jacobianT_AD_Reverse = duration (fun () -> DiffSharp.AD.Reverse.ReverseOps.jacobianT (fun x -> [|(sin x.[0]) ** x.[1]; sqrt (x.[1] + x.[2]); log (x.[0] * x.[2])|]) xv)
let res_jacobianT_Numerical, dur_jacobianT_Numerical = duration (fun () -> DiffSharp.Numerical.NumericalOps.jacobianT (fun x -> [|(sin x.[0]) ** x.[1]; sqrt (x.[1] + x.[2]); log (x.[0] * x.[2])|]) xv)
//let res_jacobianT_Symbolic, dur_jacobianT_Symbolic = duration (fun () -> DiffSharp.Symbolic.SymbolicOps.jacobianT <@ fun (x:float[]) -> [|(sin x.[0]) ** x.[1]; sqrt (x.[1] + x.[2]); log (x.[0] * x.[2])|] @> xv)
...
let res_jacobianTv_AD_Reverse, dur_jacobianTv_AD_Reverse = duration (fun () -> DiffSharp.AD.Reverse.ReverseOps.jacobianTv (fun x -> [|(sin x.[0]) ** x.[1]; sqrt (x.[1] + x.[2]); log (x.[0] * x.[2])|]) xv u)
...
let res_jacobianT'_AD_Forward, dur_jacobianT'_AD_Forward = duration (fun () -> DiffSharp.AD.Forward.ForwardOps.jacobianT' (fun x -> [|(sin x.[0]) ** x.[1]; sqrt (x.[1] + x.[2]); log (x.[0] * x.[2])|]) xv)
let res_jacobianT'_AD_Forward2, dur_jacobianT'_AD_Forward2 = duration (fun () -> DiffSharp.AD.Forward2.Forward2Ops.jacobianT' (fun x -> [|(sin x.[0]) ** x.[1]; sqrt (x.[1] + x.[2]); log (x.[0] * x.[2])|]) xv)
let res_jacobianT'_AD_ForwardG, dur_jacobianT'_AD_ForwardG = duration (fun () -> DiffSharp.AD.ForwardG.ForwardGOps.jacobianT' (fun x -> [|(sin x.[0]) ** x.[1]; sqrt (x.[1] + x.[2]); log (x.[0] * x.[2])|]) xv)
let res_jacobianT'_AD_ForwardGH, dur_jacobianT'_AD_ForwardGH = duration (fun () -> DiffSharp.AD.ForwardGH.ForwardGHOps.jacobianT' (fun x -> [|(sin x.[0]) ** x.[1]; sqrt (x.[1] + x.[2]); log (x.[0] * x.[2])|]) xv)
let res_jacobianT'_AD_ForwardN, dur_jacobianT'_AD_ForwardN = duration (fun () -> DiffSharp.AD.ForwardN.ForwardNOps.jacobianT' (fun x -> [|(sin x.[0]) ** x.[1]; sqrt (x.[1] + x.[2]); log (x.[0] * x.[2])|]) xv)
let res_jacobianT'_AD_Reverse, dur_jacobianT'_AD_Reverse = duration (fun () -> DiffSharp.AD.Reverse.ReverseOps.jacobianT' (fun x -> [|(sin x.[0]) ** x.[1]; sqrt (x.[1] + x.[2]); log (x.[0] * x.[2])|]) xv)
let res_jacobianT'_Numerical, dur_jacobianT'_Numerical = duration (fun () -> DiffSharp.Numerical.NumericalOps.jacobianT' (fun x -> [|(sin x.[0]) ** x.[1]; sqrt (x.[1] + x.[2]); log (x.[0] * x.[2])|]) xv)
//let res_jacobianT'_Symbolic, dur_jacobianT'_Symbolic = duration (fun () -> DiffSharp.Symbolic.SymbolicOps.jacobianT' <@ fun (x:float[]) -> [|(sin x.[0]) ** x.[1]; sqrt (x.[1] + x.[2]); log (x.[0] * x.[2])|] @> xv)
...
let res_jacobianTv'_AD_Reverse, dur_jacobianTv'_AD_Reverse = duration (fun () -> DiffSharp.AD.Reverse.ReverseOps.jacobianTv' (fun x -> [|(sin x.[0]) ** x.[1]; sqrt (x.[1] + x.[2]); log (x.[0] * x.[2])|]) xv u)
