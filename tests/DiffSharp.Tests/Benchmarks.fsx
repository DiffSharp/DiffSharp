...
let res_diff_AD_ForwardG, dur_diff_AD_ForwardG = duration (fun () -> DiffSharp.AD.ForwardG.ForwardGOps.diff (fun x -> sin (sqrt x)) x)
let res_diff_AD_ForwardGH, dur_diff_AD_ForwardGH = duration (fun () -> DiffSharp.AD.ForwardGH.ForwardGHOps.diff (fun x -> sin (sqrt x)) x)
...
let res_diffdir_AD_ForwardG, dur_diffdir_AD_ForwardG = 0., 0.
let res_diffdir_AD_ForwardGH, dur_diffdir_AD_ForwardGH = 0., 0.
...
let res_grad_AD_ForwardG, dur_grad_AD_ForwardG = duration (fun () -> DiffSharp.AD.ForwardG.ForwardGOps.grad (fun x -> sin (x.[0] * sqrt x.[1])) xv)
let res_grad_AD_ForwardGH, dur_grad_AD_ForwardGH = duration (fun () -> DiffSharp.AD.ForwardGH.ForwardGHOps.grad (fun x -> sin (x.[0] * sqrt x.[1])) xv)
...
let res_hessian_AD_ForwardGH, dur_hessian_AD_ForwardGH = duration (fun () -> DiffSharp.AD.ForwardGH.ForwardGHOps.hessian (fun x -> sin (x.[0] * sqrt x.[1])) xv)
...
let res_gradhessian_AD_ForwardGH, dur_gradhessian_AD_ForwardGH = duration (fun () -> DiffSharp.AD.ForwardGH.ForwardGHOps.gradhessian (fun x -> sin (x.[0] * sqrt x.[1])) xv)
...
let res_laplacian_AD_ForwardGH, dur_laplacian_AD_ForwardGH = duration (fun () -> DiffSharp.AD.ForwardGH.ForwardGHOps.laplacian (fun x -> sin (x.[0] * sqrt x.[1])) xv)
...
let res_jacobian_AD_ForwardG, dur_jacobian_AD_ForwardG = duration (fun () -> DiffSharp.AD.ForwardG.ForwardGOps.jacobian (fun x -> [| sin x.[0]; sqrt x.[1] |]) xv)
let res_jacobian_AD_ForwardGH, dur_jacobian_AD_ForwardGH = duration (fun () -> DiffSharp.AD.ForwardGH.ForwardGHOps.jacobian (fun x -> [| sin x.[0]; sqrt x.[1] |]) xv)
...
let row_AD_ForwardG = Vector.Create([| dur_diff_AD_ForwardG; dur_diff2_AD_ForwardG; dur_diffn_AD_ForwardG; dur_diffdir_AD_ForwardG; dur_grad_AD_ForwardG; dur_hessian_AD_ForwardG; dur_gradhessian_AD_ForwardG; dur_laplacian_AD_ForwardG; dur_jacobian_AD_ForwardG |]) / row_originals
let row_AD_ForwardGH = Vector.Create([| dur_diff_AD_ForwardGH; dur_diff2_AD_ForwardGH; dur_diffn_AD_ForwardGH; dur_diffdir_AD_ForwardGH; dur_grad_AD_ForwardGH; dur_hessian_AD_ForwardGH; dur_gradhessian_AD_ForwardGH; dur_laplacian_AD_ForwardGH; dur_jacobian_AD_ForwardGH |]) / row_originals
...
let benchmark = Matrix.Create([| row_AD_Forward; row_AD_Forward2; row_AD_ForwardN; row_AD_ForwardG; row_AD_ForwardGH; row_AD_Reverse; row_Numerical |])
//let benchmark = Matrix.Create([| row_AD_Forward; row_AD_Forward2; row_AD_ForwardN; row_AD_ForwardG; row_AD_ForwardGH; row_AD_Reverse; row_Numerical; row_Symbolic |])
...
let res_diff'_AD_ForwardG, dur_diff'_AD_ForwardG = duration (fun () -> DiffSharp.AD.ForwardG.ForwardGOps.diff' (fun x -> sin (sqrt x)) x)
let res_diff'_AD_ForwardGH, dur_diff'_AD_ForwardGH = duration (fun () -> DiffSharp.AD.ForwardGH.ForwardGHOps.diff' (fun x -> sin (sqrt x)) x)
...
let res_diffdir'_AD_ForwardG, dur_diffdir'_AD_ForwardG = 0., 0.
let res_diffdir'_AD_ForwardGH, dur_diffdir'_AD_ForwardGH = 0., 0.
...
let res_grad'_AD_ForwardG, dur_grad'_AD_ForwardG = duration (fun () -> DiffSharp.AD.ForwardG.ForwardGOps.grad' (fun x -> sin (x.[0] * sqrt x.[1])) xv)
let res_grad'_AD_ForwardGH, dur_grad'_AD_ForwardGH = duration (fun () -> DiffSharp.AD.ForwardGH.ForwardGHOps.grad' (fun x -> sin (x.[0] * sqrt x.[1])) xv)
...
let res_hessian'_AD_ForwardGH, dur_hessian'_AD_ForwardGH = duration (fun () -> DiffSharp.AD.ForwardGH.ForwardGHOps.hessian' (fun x -> sin (x.[0] * sqrt x.[1])) xv)
...
let res_gradhessian'_AD_ForwardGH, dur_gradhessian'_AD_ForwardGH = duration (fun () -> DiffSharp.AD.ForwardGH.ForwardGHOps.gradhessian' (fun x -> sin (x.[0] * sqrt x.[1])) xv)
...
let res_laplacian'_AD_ForwardGH, dur_laplacian'_AD_ForwardGH = duration (fun () -> DiffSharp.AD.ForwardGH.ForwardGHOps.laplacian' (fun x -> sin (x.[0] * sqrt x.[1])) xv)
...
let res_jacobian'_AD_ForwardG, dur_jacobian'_AD_ForwardG = duration (fun () -> DiffSharp.AD.ForwardG.ForwardGOps.jacobian' (fun x -> [| sin x.[0]; sqrt x.[1] |]) xv)
let res_jacobian'_AD_ForwardGH, dur_jacobian'_AD_ForwardGH = duration (fun () -> DiffSharp.AD.ForwardGH.ForwardGHOps.jacobian' (fun x -> [| sin x.[0]; sqrt x.[1] |]) xv)
...
let row_AD_ForwardG' = Vector.Create([| dur_diff'_AD_ForwardG; dur_diff2'_AD_ForwardG; dur_diffn'_AD_ForwardG; dur_diffdir'_AD_ForwardG; dur_grad'_AD_ForwardG; dur_hessian'_AD_ForwardG; dur_gradhessian'_AD_ForwardG; dur_laplacian'_AD_ForwardG; dur_jacobian'_AD_ForwardG |]) / row_originals'
let row_AD_ForwardGH' = Vector.Create([| dur_diff'_AD_ForwardGH; dur_diff2'_AD_ForwardGH; dur_diffn'_AD_ForwardGH; dur_diffdir'_AD_ForwardGH; dur_grad'_AD_ForwardGH; dur_hessian'_AD_ForwardGH; dur_gradhessian'_AD_ForwardGH; dur_laplacian'_AD_ForwardGH; dur_jacobian'_AD_ForwardGH |]) / row_originals'
