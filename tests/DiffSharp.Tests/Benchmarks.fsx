...
let res_diffdir_AD_Forward, dur_diffdir_AD_Forward = duration (fun () -> DiffSharp.AD.Forward.ForwardOps.diffdir r (fun x -> (x.[0] * (sqrt (x.[1] + x.[2])) * (log x.[2])) ** x.[1]) xv)
let res_diffdir_AD_Forward2, dur_diffdir_AD_Forward2 = duration (fun () -> DiffSharp.AD.Forward2.Forward2Ops.diffdir r (fun x -> (x.[0] * (sqrt (x.[1] + x.[2])) * (log x.[2])) ** x.[1]) xv)
let res_diffdir_AD_ForwardG, dur_diffdir_AD_ForwardG = 0., 0.
let res_diffdir_AD_ForwardGH, dur_diffdir_AD_ForwardGH = 0., 0.
let res_diffdir_AD_ForwardN, dur_diffdir_AD_ForwardN = duration (fun () -> DiffSharp.AD.ForwardN.ForwardNOps.diffdir r (fun x -> (x.[0] * (sqrt (x.[1] + x.[2])) * (log x.[2])) ** x.[1]) xv)
let res_diffdir_AD_Reverse, dur_diffdir_AD_Reverse = 0., 0.
let res_diffdir_Numerical, dur_diffdir_Numerical = duration (fun () -> DiffSharp.Numerical.NumericalOps.diffdir r (fun x -> (x.[0] * (sqrt (x.[1] + x.[2])) * (log x.[2])) ** x.[1]) xv)
...
let res_diffdir'_AD_Forward, dur_diffdir'_AD_Forward = duration (fun () -> DiffSharp.AD.Forward.ForwardOps.diffdir' r (fun x -> (x.[0] * (sqrt (x.[1] + x.[2])) * (log x.[2])) ** x.[1]) xv)
let res_diffdir'_AD_Forward2, dur_diffdir'_AD_Forward2 = duration (fun () -> DiffSharp.AD.Forward2.Forward2Ops.diffdir' r (fun x -> (x.[0] * (sqrt (x.[1] + x.[2])) * (log x.[2])) ** x.[1]) xv)
let res_diffdir'_AD_ForwardG, dur_diffdir'_AD_ForwardG = 0., 0.
let res_diffdir'_AD_ForwardGH, dur_diffdir'_AD_ForwardGH = 0., 0.
let res_diffdir'_AD_ForwardN, dur_diffdir'_AD_ForwardN = duration (fun () -> DiffSharp.AD.ForwardN.ForwardNOps.diffdir' r (fun x -> (x.[0] * (sqrt (x.[1] + x.[2])) * (log x.[2])) ** x.[1]) xv)
let res_diffdir'_AD_Reverse, dur_diffdir'_AD_Reverse = 0., 0.
let res_diffdir'_Numerical, dur_diffdir'_Numerical = duration (fun () -> DiffSharp.Numerical.NumericalOps.diffdir' r (fun x -> (x.[0] * (sqrt (x.[1] + x.[2])) * (log x.[2])) ** x.[1]) xv)
