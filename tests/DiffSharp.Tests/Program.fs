...
let main argv = 
    ...
    let res_fss, dur_fss = duration n (fun () -> (fun x -> (sin (sqrt (x + 2.))) ** 3.) x)
    let res_fvs, dur_fvs = duration n (fun () -> (fun (x:float[]) -> (x.[0] * (sqrt (x.[1] + x.[2])) * (log x.[2])) ** x.[1]) xv)
    let res_fvv, dur_fvv = duration n (fun () -> (fun (x:float[]) -> [|(sin x.[0]) ** x.[1]; sqrt (x.[1] + x.[2]); log (x.[0] * x.[2])|]) xv)
    ...
    //let res_diff_Symbolic, dur_diff_Symbolic = duration n (fun () -> DiffSharp.Symbolic.SymbolicOps.diff <@ (fun x -> (sin (sqrt (x + 2.))) ** 3.) @> x)
    ...
    //let res_diff2_Symbolic, dur_diff2_Symbolic = duration n (fun () -> DiffSharp.Symbolic.SymbolicOps.diff2 <@ (fun x -> (sin (sqrt (x + 2.))) ** 3.) @> x)
    ...
    //let res_diffn_Symbolic, dur_diffn_Symbolic = duration n (fun () -> DiffSharp.Symbolic.SymbolicOps.diffn 2 <@ (fun x -> (sin (sqrt (x + 2.))) ** 3.) @> x)
    ...
    //let res_grad_Symbolic, dur_grad_Symbolic = duration n (fun () -> DiffSharp.Symbolic.SymbolicOps.grad <@ fun (x:float[]) -> (x.[0] * (sqrt (x.[1] + x.[2])) * (log x.[2])) ** x.[1] @> xv)
    ...
    //let res_hessian_Symbolic, dur_hessian_Symbolic = duration n (fun () -> DiffSharp.Symbolic.SymbolicOps.hessian <@ fun (x:float[]) -> (x.[0] * (sqrt (x.[1] + x.[2])) * (log x.[2])) ** x.[1] @> xv)
    ...
    //let res_gradhessian_Symbolic, dur_gradhessian_Symbolic = duration n (fun () -> DiffSharp.Symbolic.SymbolicOps.gradhessian <@ fun (x:float[]) -> (x.[0] * (sqrt (x.[1] + x.[2])) * (log x.[2])) ** x.[1] @> xv)
    ...
    //let res_laplacian_Symbolic, dur_laplacian_Symbolic = duration n (fun () -> DiffSharp.Symbolic.SymbolicOps.laplacian <@ fun (x:float[]) -> (x.[0] * (sqrt (x.[1] + x.[2])) * (log x.[2])) ** x.[1] @> xv)
    ...
    //let res_jacobian_Symbolic, dur_jacobian_Symbolic = duration n (fun () -> DiffSharp.Symbolic.SymbolicOps.jacobian <@ fun (x:float[]) -> [|(sin x.[0]) ** x.[1]; sqrt (x.[1] + x.[2]); log (x.[0] * x.[2])|] @> xv)
    ...
    //let res_jacobianT_Symbolic, dur_jacobianT_Symbolic = duration n (fun () -> DiffSharp.Symbolic.SymbolicOps.jacobianT <@ fun (x:float[]) -> [|(sin x.[0]) ** x.[1]; sqrt (x.[1] + x.[2]); log (x.[0] * x.[2])|] @> xv)
    ...
    //let res_diff'_Symbolic, dur_diff'_Symbolic = duration n (fun () -> DiffSharp.Symbolic.SymbolicOps.diff' <@ (fun x -> (sin (sqrt (x + 2.))) ** 3.) @> x)
    ...
    //let res_diff2'_Symbolic, dur_diff2'_Symbolic = duration n (fun () -> DiffSharp.Symbolic.SymbolicOps.diff2' <@ (fun x -> (sin (sqrt (x + 2.))) ** 3.) @> x)
    ...
    //let res_diffn'_Symbolic, dur_diffn'_Symbolic = duration n (fun () -> DiffSharp.Symbolic.SymbolicOps.diffn' 2 <@ (fun x -> (sin (sqrt (x + 2.))) ** 3.) @> x)
    ...
    //let res_grad'_Symbolic, dur_grad'_Symbolic = duration n (fun () -> DiffSharp.Symbolic.SymbolicOps.grad' <@ fun (x:float[]) -> (x.[0] * (sqrt (x.[1] + x.[2])) * (log x.[2])) ** x.[1] @> xv)
    ...
    //let res_hessian'_Symbolic, dur_hessian'_Symbolic = duration n (fun () -> DiffSharp.Symbolic.SymbolicOps.hessian' <@ fun (x:float[]) -> (x.[0] * (sqrt (x.[1] + x.[2])) * (log x.[2])) ** x.[1] @> xv)
    ...
    //let res_gradhessian'_Symbolic, dur_gradhessian'_Symbolic = duration n (fun () -> DiffSharp.Symbolic.SymbolicOps.gradhessian' <@ fun (x:float[]) -> (x.[0] * (sqrt (x.[1] + x.[2])) * (log x.[2])) ** x.[1] @> xv)
    ...
    //let res_laplacian'_Symbolic, dur_laplacian'_Symbolic = duration n (fun () -> DiffSharp.Symbolic.SymbolicOps.laplacian' <@ fun (x:float[]) -> (x.[0] * (sqrt (x.[1] + x.[2])) * (log x.[2])) ** x.[1] @> xv)
    ...
    //let res_jacobian'_Symbolic, dur_jacobian'_Symbolic = duration n (fun () -> DiffSharp.Symbolic.SymbolicOps.jacobian' <@ fun (x:float[]) -> [|(sin x.[0]) ** x.[1]; sqrt (x.[1] + x.[2]); log (x.[0] * x.[2])|] @> xv)
    ...
    //let res_jacobianT'_Symbolic, dur_jacobianT'_Symbolic = duration n (fun () -> DiffSharp.Symbolic.SymbolicOps.jacobianT' <@ fun (x:float[]) -> [|(sin x.[0]) ** x.[1]; sqrt (x.[1] + x.[2]); log (x.[0] * x.[2])|] @> xv)
    ...
    stream.WriteLine("Rows: {DiffSharp.AD.Forward, DiffSharp.AD.Forward2, DiffSharp.AD.ForwardG, DiffSharp.AD.ForwardGH, DiffSharp.AD.ForwardN, DiffSharp.AD.Reverse, DiffSharp.Numerical}\r\n")
